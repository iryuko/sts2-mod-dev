...
> 档案状态：T4 资产接入快照。当前资产事实以 `asset-status.md` 和文件系统为准。
...
| 丰川定治地图节点 runtime 占位 | `assets/ancients/map_nodes/togawa_teiji_map_node.png` | `pack/images/packed/map/ancients/ancient_node_togawa_teiji.png` | 已接入但仍是占位 | 2026-05-05 T5 反编译确认原版 `AncientEventModel.MapIconPath` 硬编码读取 `packed/map/ancients/ancient_node_<id>.png`；旧 `pack/images/packed/ancients/map_nodes/togawa_teiji_map_node.png` 仅保留为工作副本/历史路径 |
| 丰川定治地图节点 outline runtime 占位 | `assets/ancients/map_nodes/togawa_teiji_map_node_outline.png` | `pack/images/packed/map/ancients/ancient_node_togawa_teiji_outline.png` | 已接入但仍是占位 | 2026-05-05 T5 反编译确认原版 `AncientEventModel.MapIconOutlinePath` 硬编码读取 `packed/map/ancients/ancient_node_<id>_outline.png`；旧 `pack/images/packed/ancients/map_nodes/togawa_teiji_map_node_outline.png` 仅保留为工作副本/历史路径 |
