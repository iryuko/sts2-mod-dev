...
本轮九类已识别问题已完成代码修复与针对性测试：卡牌悬空、弹琴静态音频缓存、磁力嵌套重放、奥斯提误选、Ave Mujica 免费打出，以及第二轮的弹琴异常离场音乐、联机远端展示隔离、jukebox 音量叠声、Shadow 获得楼层元数据。2026-09-24 已推送 [PR #10](https://github.com/iryuko/sts2-mod-dev/pull/10)，并按用户追加授权发布 [0.2.6](releases/2026-09-24-0.2.6.md)；尚未合并 main 或安装到本机。
