...
初建日期：2026-04-20；实现状态校订：2026-07-26

> 档案状态：页面和奖励设计已经实装。2026-07-23 已修 canonical/mutable model 共享剩余 Shadow 列表的问题，并把 visited-event 交回原版流程；同进程 SL 实机闭环仍待验证。现行事实见 [当前状态](current-status.md)。
