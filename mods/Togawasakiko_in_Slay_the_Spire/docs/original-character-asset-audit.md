...
初建日期：2026-03-24；档案校订：2026-07-26

> 证据边界：本文件主要依据 `references/pck-extract/sts2-main/` 的 v0.98.3 资源提取结果，只用于原版资源结构和尺寸参考，不用于推断 v0.107.1 API。Togawasakiko 当前资产完成度见 [资产状态](asset-status.md)。
